  ...
  d3.tsv("data/Homicide_rates-WB.tsv", function(tsv) {
    ...
    chartHomicide.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_HOMICIDE").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
