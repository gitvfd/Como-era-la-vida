  ...
  d3.tsv("data/Height-WB.tsv", function(tsv) {
    ...
    chartHeight.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_HEIGHT").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
