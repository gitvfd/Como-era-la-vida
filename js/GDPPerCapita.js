  ...
  d3.tsv("data/GDP_Per_Capita-WB.tsv", function(tsv) {
    ...
    chartGDP.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_GDP").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
