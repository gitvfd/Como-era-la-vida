  ...
  d3.tsv("data/Total_SO2_Emissions.tsv", function(tsv) {
    ...
    chartSO2.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_SO2").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
