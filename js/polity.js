  ...
  d3.tsv("data/Polity2_Index-WB.tsv", function(tsv) {
    ...
    chartPolity.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_POLITY").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
