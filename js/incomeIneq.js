  ...
  d3.tsv("data/Income_inequality-WB.tsv", function(tsv) {
    ...
    chartIncomeIneq.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_INCOMEINEQ").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
