  ...
  d3.tsv("data/Labourers-Real-Wage-WB.tsv", function(tsv) {
    ...
    chartRealWages.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_WAGE").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
