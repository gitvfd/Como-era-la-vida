  ...
  d3.tsv("data/Average_Years_of_Education-WB.tsv", function(tsv) {
    ...
    chartEducation.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_EDU").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
