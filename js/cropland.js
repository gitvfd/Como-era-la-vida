  ...
  d3.tsv("data/Total_Pasture.tsv", function(tsv) {
    ...
    chartCropland.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_CROPLAND").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
