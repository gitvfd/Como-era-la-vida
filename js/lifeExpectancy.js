  ...
  d3.tsv("data/Life_Expectancy_at_Birth-WB.tsv", function(tsv) {
    ...
    chartLifeExp.selectAll("circle")
      .on("mouseout",function(d) {
        ...
        document.getElementById("DQ_LIFEEXP").innerHTML= "Pase el ratón sobre un país para tener información sobre la calidad de los datos de 1: excelente, a 4: cifra estimada ";
